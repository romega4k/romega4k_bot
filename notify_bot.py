...
def notify_user(user_id, chat_id):
    try:
        ...
        # Trimite mesaj individual pentru fiecare client
        for c in expiring:
            name = c["name"]
            days = c["days"]
...
• 1 lună → 15€
• 3 luni → 46€ _(+1 GRATIS)_
• 5 luni → 75€ _(+2 GRATUITE)_
• 8 luni → 120€ _(+4 GRATUITE)_
...
def schedule_all():
    try:
        ...
        # Sterge job-urile vechi (dar nu refresh-ul)
...
if __name__ == "__main__":
    ...
    # Refresh la fiecare 5 minute (prinde rapid orele noi)
